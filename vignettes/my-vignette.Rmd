...
## First order two-dimensional dynamical systemss
...
- `deriv`: A function computing the derivative at a point for the ODE system to be analysed. More discussion of the required structure of these functions is supplied at the end of this section.
