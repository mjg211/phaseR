...
As a basic example, we consider analysing the non-linear two-dimensional system of ODEs provided in __phaseR__ via `example12()`. By hand, we typically first locate the nullclines and then identify the equilibrium points. Following this, we produce a plot from which trajectories can be sketched. This can all be seamlessly carried out in __phaseR__ with:
```{r}
...
Grayling MJ (2014) [phaseR: An R Package for Phase Plane Analysis of Autonomous ODE Systems](https://doi.org/10.32614/RJ-2014-023). *The R Journal* 6(2):43-51. DOI: 10.32614/RJ-2014-023.
