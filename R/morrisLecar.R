...
#' 
#' \ifelse{html}{\out{<center><i>dx</i>/<i>dt</i> = 0.05(90 -
#' 0.5<i>g</i><sub>Ca</sub>(1 + tanh(<i>x</i> + 1.2)/18))(<i>x</i> - 120) -
#' 8<i>y</i>(<i>x</i> + 84) - 2(<i>x</i> + 60),</center>}}{\deqn{\frac{dx}{dt} =
#' 0.05(90 - 0.5g_\mathrm{Ca}(1 + \mathrm{tanh}(x + 1.2)/18))(x - 120) -
#' 8y(x + 84) - 2(x + 60),}}
#' \ifelse{html}{\out{<center><i>dy</i>/<i>dt</i> = <i>&phi;</i>(0.5(1 +
#' tanh((<i>x</i> - 2)/30)) - <i>y</i>)cosh((<i>x</i> -
#' 2)/60).</center>}}{\deqn{\frac{dy}{dt} = \phi(0.5\left[1 +
